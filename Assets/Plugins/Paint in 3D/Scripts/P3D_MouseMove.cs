...
public class P3D_MouseMove : MonoBehaviour
{
	...
	protected virtual void Update()
	{
        ...
        //新加的滚轮控制缩放，后来因为功能重复给删了。
        /*
        //Zoom out
        if (Input.GetAxis("Mouse ScrollWheel") < 0)
        {
            //targetPosition -= transform.forward * Input.GetAxis("Mouse ScrollWheel") * Speed * Time.deltaTime;
            targetPosition -= transform.forward * 1 * Speed * Time.deltaTime;
        }
        //Zoom in
