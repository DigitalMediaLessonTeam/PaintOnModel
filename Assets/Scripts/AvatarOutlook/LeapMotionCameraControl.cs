...
[ExecuteInEditMode]
public class LeapMotionCameraControl : MonoBehaviour {

    [Tooltip("The key that must be held down to mouse look")]
    public KeyCode Requires = KeyCode.Mouse1;
    ...
    protected virtual void Update()
    {
        ...
        TargetYaw += Bokjan.LeapMotionManager.AxisX;
        ...
        //print(TargetYaw+"  "+currentYaw);
        transform.RotateAround(point, axis, currentYaw - TargetYaw);
    }
}
